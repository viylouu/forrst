...
COMPILER=("zig" "cc")
CFLAGS="-std=c99"
FLAGS_COMP="-pedantic -Wall -Wextra -Werror -Wno-initializer-overrides -Wno-override-init -Wno-override-init-side-effects -Ifurry -I. -Ideps -Ideps/imgui -Ifurry/deps/imgui -Ifurry/deps -isystem"
FLAGS_LINK=""
