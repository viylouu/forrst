...
namespace fur {
    ...
    public:
        ...
        void glfwSetPtr(fur::State* state) { glfwSetWindowUserPointer(window, state); }
    ...
    s32 fur_windowDoShit(const char* title, v2 dims) {
        fur::Program* forcetype = static_cast<Tprogram*>(0); (void)forcetype;

        fur::State* st = new fur::State();
        st->glfwSetPtr(st);
